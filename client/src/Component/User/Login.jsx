...
function Login() {
  ...
  const afterGoogle = (data) => {
    console.log(data);
    axios.post(`${userApi}googleAuthentication`, { data: data }).then((res) => {
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="mt-16 grid space-y-4">
              <a
                ...
                className="group h-10 px-6 border-2 border-gray-300 rounded-full transition duration-300 hover:border-blue-400 focus:bg-blue-50 active:bg-blue-100"
              >
                <div className="relative flex items-center space-x-4 justify-center">
                  <img
                    src="https://tailus.io/sources/blocks/social/preview/images/google.svg"
                    className="mt-2 absolute left-0 w-5"
                    alt="google logo"
                  />
                  <span className="block w-max font-semibold tracking-wide text-gray-700 text-sm transition duration-300 group-hover:text-blue-600 sm:text-base mt-1">
            ...
            <div className="flex justify-center">
              <a
                href="#"
                className="inline-block text-center text-blue-500 hover:text-blue-800 hover:underline"
              >
                Forget password
              </a>
            </div>
