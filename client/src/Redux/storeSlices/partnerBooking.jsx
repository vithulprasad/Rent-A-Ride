...
const partnerBooking = createSlice({
  name: "partnerBooking",
  initialState: [],
  reducers: {
...
export const {setBookingList,preBooking,ongoing,cancel,complete} = partnerBooking.actions;
export default partnerBooking.reducer;